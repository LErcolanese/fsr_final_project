function sequence_exampleHelperAvoidObstaclesPosePlot(u, mapMatrix, mapScale, range, scanAngles, ax, targets)
    ...
    % Dimensioni del rettangolo: 1.2 x 1.8 metri
    rectangleWidth = 1;
    rectangleHeight = 1.8;
    ...
    if nargin > 6 && ~isempty(targets)
        ...
        plot(ax, targets(i,1), targets(i,2), 'bX', 'MarkerSize', 10, 'LineWidth', 2); % "X" blu con dimensioni personalizzate
