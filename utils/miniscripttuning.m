...
set_param("sequence_dwa_obstacle_avoidance","StopTime","250");
%load map
% load simpleMap.mat
...
% Loop su tutte le righe della matrice k_success
for i = 1:size(k_success, 1)
    % Estrai i valori di k1, k2 e k3 dalla riga corrente
    k1 = k_success(i,1);
    k2 = k_success(i,2);
    k3 = k_success(i,3);
